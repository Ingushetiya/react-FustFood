...
import { setSort, Sort } from '../store/slices/filterSlice';
import { SortPropertyEnum } from '../store/slices/filterSlice';
...
const SortPopup: React.FC<SortTypeProp> = React.memo(({ value }) => {
